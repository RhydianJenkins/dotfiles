return require("packer").startup(function()
    ...
    use{'nvim-telescope/telescope.nvim'} -- fzf file search
    use{'nvim-telescope/telescope-fzf-native.nvim', { run = 'make' }} -- speed bonus for fzf file search
    use{'nvim-telescope/telescope-frecency.nvim'} -- prioritise results based on recently used (needs sqlite)
    ...
    use{'akinsho/bufferline.nvim'} -- show buffers at the top
