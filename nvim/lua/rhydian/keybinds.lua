...
set("n", "<F10>", dap.step_into, { desc = "Debug step into" })
set("n", "<F11>", dap.step_out, { desc = "Debug step out" })
set("n", "<F1>", dapui.eval, { desc = "Debug evaluate" })
set("n", "<F4>", dapui.toggle, { desc = "Debug toggle" })
set("n", "<F5>", dap.toggle_breakpoint, { desc = "Debug toggle breakpoint" })
set("n", "<F6>", dap.continue, { desc = "Debug continue" })
set("n", "<F9>", dap.step_over, { desc = "Debug step over" })
