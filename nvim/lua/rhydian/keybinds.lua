...
set("n", "<F10>", function() require("dap").step_into() end, { desc = "Debug step into" })
set("n", "<F11>", function() require("dap").step_out() end, { desc = "Debug step out" })
set("n", "<F1>", function() require("dapui").eval() end, { desc = "Debug evaluate" })
set("n", "<F4>", function() require("dapui").toggle() end, { desc = "Debug toggle" })
set("n", "<F5>", function() require("dap").toggle_breakpoint() end, { desc = "Debug toggle breakpoint" })
set("n", "<F6>", function() require("dap").continue() end, { desc = "Debug continue" })
set("n", "<F9>", function() require("dap").step_over() end, { desc = "Debug step over" })
...
set("n", "K", function() vim.lsp.buf.hover({ border = "rounded" }) end, { desc = "Add rounded border to hover docs" })
...
set("n", "grd", vim.lsp.buf.definition, { desc = "[G]oto [D]efinition; a gd alias for consistency with other gr commands" })
